...
# It controls all enemy behavior including:
#
# - spawning enemies 
# - moving enemies 
# - drawing enemies 
...
# Iterates through the enemy array and draws all active enemies 
# using sprite rendering functions from display.asm.
